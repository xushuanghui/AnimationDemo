...
//  侧滑菜单
//
//  Created by shuanghui on 15/7/13.
//  Copyright (c) 2015年 shuanghui. All rights reserved.
//
...
//    [_demoView.layer addAnimation:anima forKey:@"rotateAnimation"];
    ...
    anima.toValue = [NSValue valueWithCATransform3D:CATransform3DMakeRotation(M_PI, 0, 1, 0)];//绕着矢量（x,y,z）旋转
    anima.duration = 1.0f;
